...
JOB_BUDGET_VAR, SESSION_BUDGET_VAR = "LR_ANALYST_JOB_BUDGET_USD", "LR_ANALYST_SESSION_BUDGET_USD"
...
NO_RUNNER = "the analyst job runner (legacy_reader.api.jobs) is not in this build, so nothing can be submitted"
