"""`lr interface ask`: one conversation with the interface agent from the terminal, under a hard budget.
...
def ask_cmd(
    ...
    model: str = typer.Option("", "--model", help="default: LR_INTERFACE_MODEL, else z-ai/glm-5.3-flash"),
