"""`lr cache` and `lr spend`: the runtime's own commands. Registered by `legacy_reader.cli`."""
...
def spend_show_cmd() -> None:
    """Spend per backend family against its ceiling, and the total against LR_MAX_SPEND_USD."""
