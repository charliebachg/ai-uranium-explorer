...
to `z-ai/glm-5.3-flash` through OpenRouter and is read from `UE_INTERFACE_MODEL` when that is set.
"""
...
#: the cheap model the router and the answer run on unless `UE_INTERFACE_MODEL` says otherwise
DEFAULT_MODEL = "z-ai/glm-5.3-flash"
MODEL_VAR = "UE_INTERFACE_MODEL"
