"""`ue store rebuild`: flatten every stage into the tiered DuckDB store, plus the two GeoParquet layers.
...
#: kept so `ue run phase2` and older call sites do not change meaning
stage_store = rebuild
